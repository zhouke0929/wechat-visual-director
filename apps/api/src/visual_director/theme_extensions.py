...
def render_extended_hero(title: str, plan_name: str, component_version: str, kicker: str, config: dict[str, Any]) -> str | None:
    ...
    meta = f"{html.escape(plan_name)} · {html.escape(component_version)}"
    distinct = _distinct_hero(title_html, meta, kicker, grammar, p)
    if distinct is not None:
        hero_assets = {
